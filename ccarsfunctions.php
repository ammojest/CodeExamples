...
// Removes stuff from Woocommerce
...
// Removes Add to Cart Functionality from Woocommerce
...
// ====================================================================================
//                               Start of the custom Archive Page
//               eg https://www.contractcars.com/product-category/car-lease-cars/
// ====================================================================================
...
function tjames_adds_key_feats() {
    ...
    if( $dab = get_sub_field( 'dab_radio', $product->get_id() ) ) {
        echo '<img src="/wp-content/uploads/dab-radio.svg" width="23" height="23" alt="dab radio" class="dab_icon" />';
    }
   if( $bluetooth2 = get_sub_field( 'bluetooth', $product->get_id() ) ) {
        echo '<img src="/wp-content/uploads/bluetooth.svg" width="23" height="23" alt="bluetooth" alt="bluetooth" class="dab_icon" />';
    }
    if( $cruisecontrol2 = get_sub_field( 'cruise_control', $product->get_id() ) ) {
        echo '<img src="/wp-content/uploads/cruise-control.svg" width="23" height="23" alt="cruise-control" alt="crusie control" class="dab_icon" />';
    }
    if( $aircon2 = get_sub_field( 'air_conditioning', $product->get_id() ) ) {
        echo '<img src="/wp-content/uploads/air-con.svg" width="23" height="23" alt="air-con" alt="air con" class="dab_icon" />';
    }
    if( $satnav2 = get_sub_field( 'satellite_navigation', $product->get_id() ) ) {
        echo '<img src="/wp-content/uploads/sat-nav.svg" width="23" height="23" alt="sat-nav" alt="sat nav" class="dab_icon" />';
    }
    if( $heatedseats2 = get_sub_field( 'heated_seats', $product->get_id() ) ) {
        echo '<img src="/wp-content/uploads/heated-seats.svg" width="23" height="23" alt="heated-seats" alt="sat nav" class="dab_icon" />';
    }
    if( $applecc = get_sub_field( 'apple_carplay', $product->get_id() ) ) {
        echo '<img src="/wp-content/uploads/new_size_car_play.svg" width="23" height="23" alt="apple-carplay" alt="apple carplay" class="dab_icon" />';
    }
        ...
        while ( have_rows('main_details') ) : the_row();
            if( $sale_badge = get_sub_field( 'sale_badge', $product->get_id() ) ) {
                // $sale_badge = str_replace(' ', '_', $sale_badge);
                    echo '<p class="' . $sale_badge .'">' . $sale_badge . '</p>';
                }
        endwhile;
...
function add_archive_price() {
    ...
    // This adds the price to the woocommerce archive
...
function new_product_title() {
    ...
    if( have_rows('main_details') ):
        ...
        echo '<div class="container">';
            ...
            // Adds the featured icons to product page
            ...
            echo '<p class="key_features">Key Features</p>';
                ...
                echo '<img src="/wp-content/uploads/kf_spp_dab.svg" width="137" height="46" alt="dab radio" class="kf_icon" />';
                }
                if( $bluetooth2 = get_sub_field( 'bluetooth', $product->get_id() ) ) {
                echo '<img src="/wp-content/uploads/kf_spp_bluetooth.svg" width="137" height="46" alt="bluetooth" class="kf_icon" />';
                }
                if( $cruisecontrol2 = get_sub_field( 'cruise_control', $product->get_id() ) ) {
                echo '<img src="/wp-content/uploads/kf_spp_cruise.svg" width="137" height="46" alt="cruise control" class="kf_icon" />';
                }
                if( $aircon2 = get_sub_field( 'air_conditioning', $product->get_id() ) ) {
                echo '<img src="/wp-content/uploads/kf_spp_ac.svg" width="137" height="46" alt="air con" class="kf_icon" />';
                }
                if( $satnav2 = get_sub_field( 'satellite_navigation', $product->get_id() ) ) {
                echo '<img src="/wp-content/uploads/kf_spp_satnav.svg" width="137" height="46" alt="sat nag" class="kf_icon" />';
                }
                if( $heatedseats2 = get_sub_field( 'heated_seats', $product->get_id() ) ) {
                echo '<img src="/wp-content/uploads/kf_spp_heatedseats.svg" width="137" height="46" alt="heated seats" class="kf_icon" />';
                }
                if( $applecc = get_sub_field( 'apple_carplay', $product->get_id() ) ) {
                echo '<img src="/wp-content/uploads/apple-carplay-logo.svg" width="137" height="46" alt="carplay" class="kf_icon" />';
                }
        ...
        if( $switchon = get_sub_field( 'active_12', $product->get_id() ) ) {
            ...
            echo '<td class="cc-show-personal price">';
                ...
                if( $personal129 = get_sub_field( 'personal_12', $product->get_id() ) ) {
                    ...
                    print '£'.number_format((float)$personalprice129, 2, '.', '').'<span class="lowprice">Lowest Price</span>';
                } 
            ...
            if( $switchon112 = get_sub_field( '1_month_12', $product->get_id() ) ) {
                ...
                echo '<td class="cc-show-personal price">';
                    ...
                    if( $rep6active12 = get_sub_field( '1_month_replacement_12', $product->get_id() ) ) {
                        print '£'.number_format((float)$rep6active12, 2, '.', '').'<span class="lowdeposit">Lowest Upfront</span>';
                    } else if ($personal129 === "0") {
                        echo 'CALL';
                    } else {
                        print '£'.number_format((float)$personalprice123, 2, '.', '').'<span class="lowdeposit">Lowest Upfront</span>';
                    } 
                ...
                echo '<td class="cc-show-business price">';
                    ...
                    if ($businessprice129 === '0') {
                        ...
                        print '£'.number_format((float)$businessprice121, 2, '.', '').'<span class="lowdeposit">Lowest Upfront</span>';
                    }
      ...
      if( $switchon = get_sub_field( 'active_18', $product->get_id() ) ) {
            ...
            if( $switchon118 = get_sub_field( '1_month_18', $product->get_id() ) ) {
                ...
                echo '<td class="cc-show-personal price">';
                    ...
                    if( $rep6active18 = get_sub_field( '1_month_replacement_18', $product->get_id() ) ) {
                        ...
                        print '£'.number_format((float)$personalprice181, 2, '.', '').'<span class="lowdeposit">Lowest Upfront</span>';
                    } 
       ...
       if( $switchon = get_sub_field( 'active', $product->get_id() ) ) {
            ...
            if( $turnonprofile = get_sub_field( 'fee_30', $product->get_id() ) ) {
                ...
                $businessprice306                   = ($businessprice309 * 38 / 35) + 3;
                $personalprice306                   = ($businessprice306 / 100) * 20 + $businessprice306;
                $businessprice303                   = ($businessprice309 * 38 / 32) + 5;
                $personalprice303                   = ($businessprice303 / 100) * 20 + $businessprice303;
                $businessprice301                   = ($businessprice309 * 38 / 29) + 7.5;              
        ...
        if( $switchon = get_sub_field( 'active_30', $product->get_id() ) ) {
            ...
            if( $turnonprofile36 = get_sub_field( 'fee_36', $product->get_id() ) ) {
                ...
                $businessprice366                   = ($businessprice369 * 44 / 41) + 3;
                $personalprice366                   = ($businessprice366 / 100) * 20 + $businessprice366;
                $businessprice363                   = ($businessprice369 * 44 / 38) + 5;
                $personalprice363                   = ($businessprice363 / 100) * 20 + $businessprice363;
                $businessprice361                   = ($businessprice369 * 44 / 36) + 7.5;              
